...
namespace PStructure.PersistenceLayer.PdoArea.PdoCruds
{
    ...
    public interface ICrud<T>
    {
        ...
        /// <returns></returns>
        int Create(IEnumerable<T> items, ref DbContext dbContext, ILogger logger);
        ...
        /// <param name="logger"></param>
        /// <returns></returns>
        IEnumerable<T> Read(IEnumerable<T> items, ref DbContext dbContext, ILogger logger);
        ...
        /// <param name="logger"></param>
        /// <returns></returns>
        IEnumerable<T> ReadAll(ref DbContext dbContext, ILogger logger);
        ...
        /// <param name="logger"></param>
        /// <returns></returns>
        int Update(IEnumerable<T> items, ref DbContext dbContext, ILogger logger);
        ...
        /// <param name="logger"></param>
        /// <returns></returns>
        int Delete(IEnumerable<T> items, ref DbContext dbContext, ILogger logger);
